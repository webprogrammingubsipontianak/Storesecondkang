<template>
  ...
  <header class="header-section">
    <div class="header-top">
      <div class="container">
        <div class="ht-left">
          <div class="mail-service"><i class="fa fa-envelope"></i> hello.secondkang@gmail.com</div>
          <div class="phone-service"><i class="fa fa-phone"></i> +62 811-5672-307</div>
        </div>
      </div>
    </div>
    <div class="container">
      <div class="inner-header">
        <div class="row">
          <div class="col-lg-2 col-md-2">
            <div class="logo">
              <a href="./index.html">
                <img src="img/logo_web_secondkang.png" alt="" />
              </a>
            </div>
          </div>
